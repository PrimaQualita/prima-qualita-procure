...
export default function Credenciamentos() {
  ...
  const loadData = async () => {
    try {
      ...
      // Buscar processos marcados com credenciamento = true
      ...
      toast.error("Erro ao carregar dados de credenciamento");
    } finally {
      setLoading(false);
    }
  };
                    ...
                    <div className="space-y-3">
                      {processos[contrato.id].map((processo) => (
                        ...
                        >
                          ...
                          <Button
                            onClick={() => {
                              // TODO: Navegar para página de gerenciamento do credenciamento
