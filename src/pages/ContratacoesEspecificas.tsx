    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
        {loading ? (
          ...
          <Card>
            <CardHeader>
              <CardTitle>Contratações Específicas</CardTitle>
              <CardDescription>
                Selecione um contrato para visualizar os processos de contratação específica
              </CardDescription>
            </CardHeader>
                  ...
                  <TableBody>
                    {contratosFiltrados.length === 0 ? (
                      ...
                      contratosFiltrados.map((contrato, index) => (
                        <TableRow key={contrato.id} <TableRow key={contrato.id} className={index % 2 === 0 ? "bg-green-100 dark:bg-green-900/40" : "bg-blue-100 dark:bg-blue-900/40"}>>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle>Processos de Contratação Específica</CardTitle>
                  <CardDescription>
