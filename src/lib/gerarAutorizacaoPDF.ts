...
export const gerarAutorizacaoCompraDireta = async (
  ...
  const espacamentoAposAssunto = 8; // Espaçamento reduzido após o assunto
  let yPos = 72 + (linhasAssunto.length * 5) + espacamentoAposAssunto;
  ...
  yPos += linhas1.length * 5 * 1.25 + 4; // Espaçamento reduzido antes da tabela
