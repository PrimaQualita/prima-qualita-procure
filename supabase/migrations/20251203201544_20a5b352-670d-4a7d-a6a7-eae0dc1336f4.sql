...
-- Adicionar coluna para armazenar URL do PDF da proposta de cotação
ALTER TABLE cotacao_respostas_fornecedor 
ADD COLUMN IF NOT EXISTS url_pdf_proposta text;

-- Atualizar função get_all_file_references para incluir propostas de cotação
